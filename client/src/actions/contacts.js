...
export const fetchConversations = () => async dispatch => {
  ...
  if (userResponse.status === 200) {
    ...
    if (
      ...
      conversationId =
        userResponse.data.conversations[contactChatDisplayIndex].conversationId;
      ...
      if (conversationsResponse.status === 200) {
        ...
        dispatch({
          ...
          isOnline:
            userResponse.data.conversations[contactChatDisplayIndex].isOnline,
          socketId:
            userResponse.data.conversations[contactChatDisplayIndex].socketId
        });
        dispatch({
          type: UPDATE_CHAT,
