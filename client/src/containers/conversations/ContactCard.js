      ...
      <button
        ...
        onClick={e =>
          this.onCloseConversation(
            ...
            contacts.selectedConversationInfo.selectedContactMongoDBInfo.id,
    ...
    return (
      ...
      >
        ...
        >
          ...
          {this.renderContactAge(selectedContact.age, colorTheme.text6Color)}
          <LinkedIn value={selectedContact.linkedInPublicProfileUrl} />
